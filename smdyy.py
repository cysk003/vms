...
class JpySvip(object):
    ...
    def getVideoInfo(self, data):
        hl = hashlib.md5()
        hl.update('rXjWvXl6'.encode(encoding='utf-8'))
        a = hl.hexdigest()
        c = a.encode(encoding='utf-8')
        d = 'NXbHoWJbpsEOin8b'.encode(encoding='utf-8')
        cipher = AES.new(c, AES.MODE_CBC, d)
        uTxt = base64.b64decode(data)
        result = cipher.decrypt(uTxt)
...
if __name__ == '__main__':
    vip = JpySvip()
    print(vip.getVideoInfo("bk5IlUu3cIm23fku3ifixvkapfA/wKsDHnbKoCUApR4yAoSmZ1ygFeQrw7hdHaFWlgOSBXlkcOXSoxpt4DKx3T9rey2oEmQlciAwOi9MAM+fgJRRKsVIdr5CmqxFiDc0EsdBxJV3hkRFBDXnNNb6rPj6Xrye2ar1MFc5i2jImY4="))
