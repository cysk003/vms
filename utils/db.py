...
class DataBase (object) :
    ...
    def create (self) :
        ...
        sql = 'create table ' + self.table + ' (id integer PRIMARY KEY autoincrement, title text, quality text, url text,tvg_id integer, tvg_name text, logo text, group_name text, level integer, cros integer,  enable integer, online integer, delay integer, udTime text)'
